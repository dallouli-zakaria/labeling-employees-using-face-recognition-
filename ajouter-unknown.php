...
rename($results[0]->source,$source);
...
if($lastInsertId)
{
$msg="Inconnu ajouté avec succès";
}
else
{
...
<div class="col-sm-10">
<input type="text" name="fullanme" class="form-control" id="fullanme" value="unknown"  autocomplete="off" required>
</div>
</div>
...
{ ?>
<img class="form control" style="max-height:100px;min-height:100px;" src="<?php echo $result->source; }}?>" alt="">
</div>
</div>
